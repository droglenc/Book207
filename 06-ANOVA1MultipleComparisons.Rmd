...
Tukey's procedure is computed with a two-step process. First, use `emmeans()` with the `lm()` object as the first argument and a `specs=` argument with `pairwise~` followed by the name of the explanatory variable that identifies the groups. The results from this function should be saved to an object.
