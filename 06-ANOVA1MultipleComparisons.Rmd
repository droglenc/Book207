# Multiple Comparisons {#ANOVA1MultipleComparisons}
...
::: {.tip data-latex=""}
**Pairwise error rate:** The probability of a Type I error in a single comparison of two means. Sometimes called an comparison-, individual-, or test-wise error.
:::
