...
```{r Signal2NoiseMetaphor, echo=FALSE, out.width="75%", fig.cap="Signal-to-noise metahpors - seeing car lights through fog (Left) and seeing a kayak in the waves (Right).", fig.show="hide"}
