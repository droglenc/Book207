...
```{r FullResid3, echo=FALSE, fig.width=7, fig.cap='Same plots as previously but with a "large" residual shown in red and a "small" residual shown in blue.'}
t2a <- t2 +
...
```{r RSS1, echo=FALSE, fig.width=7, fig.cap='Same plots as previously but with all residuals shown.'}
t2b <- t2 +
