...
p &= \frac{e^{\alpha+\beta X}}{1+e^{\alpha+\beta X}} = \frac{e^{log(odds)}}{1+e^{log(odds)}} = \frac{\text{odds}}{1+\text{odds}}
\end{split}
$$

Thus, a probability can be calculated from the odds with $p=\frac{\text{odds}}{1+\text{odds}}$.

These relationships will be expanded upon in the next module.
