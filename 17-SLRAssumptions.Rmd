...
```{r SLRInfluentialPoint, echo=FALSE, fig.show="hold", fig.cap="Scatterplot with a best-fit line for all points (dashed red) and all points excluding the red point (solid black) (Left) and the residual plot from the fit to all points (Right)."}
