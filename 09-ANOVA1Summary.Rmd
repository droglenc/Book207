...
Specific parts of a full One-Way ANOVA analysis have been described in Modules \@ref(ANOVA1Foundations)-\@ref(ANOVA1Transformations). In this module, a workflow for a full analysis is offered and that workflow is demonstrated with several examples.
...
This study was "balanced" as the number of pots at each nematode density is the same (Table \@ref(tab:TNSampleSize)). The sample size, though, is quite small.
