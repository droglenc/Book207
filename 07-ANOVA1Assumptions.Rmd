...
* Researchers measured the self-esteem for 10 people following a specific diet at three time points -- beginning, middle, and end of the study. They wanted to determine if self-esteem increased over the time that individuals were on the diet. This example lacks *among-group* independence because the same 10 people were in each of the "groups" (i.e., beginning, middle, and end time periods).
...
Normality is often tested by simply viewing a histogram or Q-Q plot of residuals. For an adequate sample size, a histogram that is not strongly skewed is usually adequate for a One-Way ANOVA.
